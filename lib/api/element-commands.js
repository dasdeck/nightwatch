...
module.exports = function(client) {
   ...
   * @param {string} selector The CSS/Xpath selector used to locate the element.
   * @param {number} [xoffset] X offset to move to, relative to the top-left corner of the element. Defaults to the center of the element.
   * @param {number} [yoffset] Y offset to move to, relative to the top-left corner of the element. Defaults to the center of the element.
   * @param {function} [callback] Optional callback function to be called when the command finishes.
   * @see moveTo
   * @api commands
   */
  elementCommands.moveToElement = ['moveTo'];
